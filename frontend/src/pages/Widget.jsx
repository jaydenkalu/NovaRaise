...
const styles = {
  shell: {
    ...
    margin: 0,
    padding: '0.5rem',
    background: 'var(--novaraise-bg, #fff)',
    fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
    color: 'var(--novaraise-text, #111827)',
  },
  card: {
    boxSizing: 'border-box',
    width: '100%',
    minHeight: '120px',
    padding: '0.75rem',
    border: '1px solid var(--novaraise-border, #e5e5e5)',
    borderRadius: '10px',
    background: 'var(--novaraise-card, #fff)',
    color: 'var(--novaraise-text, #111827)',
  },
  title: {
    minWidth: 0,
    marginBottom: '0.45rem',
    color: 'var(--novaraise-title, #111827)',
    fontSize: '0.95rem',
    fontWeight: 700,
    lineHeight: 1.2,
    overflow: 'hidden',
  ...
  progressTrack: {
    ...
    overflow: 'hidden',
    borderRadius: '99px',
    background: 'var(--novaraise-track, #f0f0f0)',
  },
  progressFill: {
    height: '100%',
    borderRadius: '99px',
    background: 'var(--novaraise-accent, #7c3aed)',
    transition: 'width 200ms ease',
  },
  meta: {
    color: 'var(--novaraise-muted, #555)',
    fontSize: '0.75rem',
    lineHeight: 1.35,
  },
  link: {
    ...
    marginTop: '0.3rem',
    color: 'var(--novaraise-accent, #7c3aed)',
    fontSize: '0.75rem',
    fontWeight: 600,
    textDecoration: 'none',
  },
