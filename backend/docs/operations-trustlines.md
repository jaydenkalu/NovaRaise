...
NovaRaise hides trustline and reserve mechanics from contributors. The backend ensures custodial accounts can hold every **configured credit asset** (for example USDC and any entries in `STELLAR_EXTRA_ASSETS`) before money moves on-chain.
